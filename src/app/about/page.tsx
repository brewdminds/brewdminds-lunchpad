...
export const metadata: Metadata = {
  ...
  description:
    "The Brewdminds story: a strategy-led, craft-obsessed agency built for brands that refuse to be forgettable.",
  openGraph: {
    title: "About Brewdminds",
    description: "Strategy-first, craft-obsessed. The origin story of Brewdminds.",
  },
  ...
  return (
    <>
      ...
      <section className="container-page py-24">
        ...
        <h2 className="mt-3 text-4xl md:text-5xl mb-12">Our values</h2>
      ...
      <section className="container-page pb-24">
        ...
        <h2 className="mt-3 text-4xl md:text-5xl mb-12">Small, senior, sharp.</h2>
      ...
      <section className="container-page pb-24">
        <div className="rounded-3xl bg-[color:var(--ink)] text-white p-12 md:p-16 text-center">
          <h2 className="text-3xl md:text-4xl text-white">Think we'd click?</h2>
